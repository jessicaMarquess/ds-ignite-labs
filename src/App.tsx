...
function App() {
  return (
    <div className='w-screen h-screen bg-gray-900 flex flex-col items-center justify-center'>
      ...
      <form className='flex flex-col items-stretch w-full mt-10 max-w-[400px] gap-4'>
        <label htmlFor='email' className='flex flex-col gap-3'>
          <Text className='font-semibold'>Endereço de e-mail</Text>
          <TextInput.Root>
            <TextInput.Icon><Envelope /></TextInput.Icon>
            <TextInput.Input required type='email' placeholder='Digite seu e-mail' />
          </TextInput.Root>
        </label>
        <label htmlFor='password' className='flex flex-col gap-3'>
          ...
          <TextInput.Root>
            ...
            <TextInput.Input required type='password' placeholder='************' />
          </TextInput.Root>
        </label>
      ...
      <footer className='flex flex-col gap-4 items-center mt-8'>
        <Text asChild size='sm'>
          <a href='' className='text-gray-400 underline transition-colors hover:text-gray-200'>Esqueceu a senha</a>
        </Text>
        <Text asChild size='sm'>
